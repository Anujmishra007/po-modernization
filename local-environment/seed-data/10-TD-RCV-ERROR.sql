...
('RCV-ERR-001', 1, 'PO-ERR-002', 1, 'TEST_STORER_001', 'TEST-SKU-001', 100, 100, '9', 'TEST-LOC-01')
...
INSERT INTO receiptdetail (receiptkey, receiptlinenumber, orderkey, orderlinenumber, storerkey, sku, qtyexpected, qtyreceived, status, toloc) VALUES
('RCV-ERR-002', 1, 'PO-ERR-003', 1, 'TEST_STORER_001', 'TEST-SKU-001', 100, 0, 'X', 'TEST-LOC-01')
ON CONFLICT (receiptkey, receiptlinenumber) DO NOTHING;
...
INSERT INTO receiptdetail (receiptkey, receiptlinenumber, orderkey, orderlinenumber, storerkey, sku, qtyexpected, qtyreceived, status, toloc) VALUES
('RCV-ERR-003', 1, 'PO-HAPPY-001', 1, 'TEST_STORER_001', 'TEST-SKU-001', 100, 120, '5', 'TEST-RECV-01')  -- 120% received
ON CONFLICT (receiptkey, receiptlinenumber) DO NOTHING;
...
INSERT INTO receiptdetail (receiptkey, receiptlinenumber, orderkey, orderlinenumber, storerkey, sku, qtyexpected, qtyreceived, status, toloc) VALUES
('RCV-ERR-004', 1, 'PO-HAPPY-003', 1, 'TEST_STORER_001', 'TEST-SKU-001', 10000, 10000, '5', 'TEST-LOC-FULL')  -- Full location
ON CONFLICT (receiptkey, receiptlinenumber) DO NOTHING;
...
INSERT INTO receiptdetail (receiptkey, receiptlinenumber, orderkey, orderlinenumber, storerkey, sku, qtyexpected, qtyreceived, status, toloc) VALUES
('RCV-ERR-005', 1, 'PO-HAPPY-004', 1, 'NIKE_KR', 'NK-AIRMAX90-BLK', 500, 500, '5', 'KR01-RECV-01')  -- Missing lottables
ON CONFLICT (receiptkey, receiptlinenumber) DO NOTHING;
...
INSERT INTO receiptdetail (receiptkey, receiptlinenumber, orderkey, orderlinenumber, storerkey, sku, qtyexpected, qtyreceived, status, toloc) VALUES
('RCV-EDGE-001', 1, 'PO-HAPPY-002', 1, 'TEST_STORER_001', 'TEST-SKU-001', 200, 0, '5', 'TEST-RECV-01'),  -- Zero received
('RCV-EDGE-001', 2, 'PO-HAPPY-002', 2, 'TEST_STORER_001', 'TEST-SKU-002', 150, 150, '5', 'TEST-RECV-01')  -- Normal
ON CONFLICT (receiptkey, receiptlinenumber) DO NOTHING;
...
INSERT INTO receiptdetail (receiptkey, receiptlinenumber, orderkey, orderlinenumber, storerkey, sku, qtyexpected, qtyreceived, status, toloc) VALUES
('RCV-EDGE-002', 1, 'PO-ERR-008', 1, 'TEST_STORER_001', 'TEST-SKU-001', 100, 100, '5', 'TEST-RECV-01')
ON CONFLICT (receiptkey, receiptlinenumber) DO NOTHING;
